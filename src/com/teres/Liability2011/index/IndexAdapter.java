...
public class IndexAdapter extends ArrayAdapter<Index> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			holder.timeORplace = (TextView) convertView.findViewById(R.id.index_time_or_place);
			holder.title = (TextView) convertView.findViewById(R.id.index_title);
			holder.description = (TextView) convertView.findViewById(R.id.index_description);
